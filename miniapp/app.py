...
def signals(x_telegram_init_data: str = Header(default="")):
    ...
    if not DATABASE_URL:
        return [
            {"id": 3, "symbol": "BTC_USDT", "side": "LONG", "confidence": 0.78, "entry": 104250, "stop": 101860, "tp1": 107400, "created_at": "2026-06-22T08:25:00Z"},
            {"id": 2, "symbol": "SOL_USDT", "side": "SHORT", "confidence": 0.69, "entry": 148.2, "stop": 152.6, "tp1": 141.5, "created_at": "2026-06-22T07:05:00Z"},
            {"id": 1, "symbol": "ETH_USDT", "side": "LONG", "confidence": 0.66, "entry": 3540, "stop": 3448, "tp1": 3695, "created_at": "2026-06-22T05:05:00Z"},
        ]
    with db() as connection, connection.cursor() as cursor:
        cursor.execute(
            """
            SELECT id, symbol, side, confidence, entry, stop, tp1, created_at
